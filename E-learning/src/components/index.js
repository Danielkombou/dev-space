...
//     <div
//       onClick={onClick}
//       className={`cursor-pointer flex flex-row justify-between items-center gap-4 lg:gap-64`}
//     >
//       <h2 className="font-medium text-left lg:text-xl lg:text-[#010823] lg:justify-start lg:items-start">
//         {question}
//       </h2>
//       <button className="font-bold text-2xl lg:text-5xl text-[#010823]">
//         <ChevronDown
//           className={`transform ${
...
//   return (
//     <div className="container px-4 flex flex-col lg:justify-start lg:items-center gap-4">
...
//             </div>
//           </div>
//           <hr className="w-full lg:h-[2px] lg:bg-slate-400" />
//         </div>
//       ))}
//     </div>
//   );
...
// function Allfaq() {
//   return (
//     <div className="mt-8 mb-16 flex flex-col justify-center items-center lg:gap-8 lg:mt-16 lg:mb-16">
//       <div className="font-semibold text-xl lg:font-bold lg:text-center lg:text-3xl mb-4 text-[#010823] justify-center">
